    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-10 md:py-14">
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="rounded-2xl border border-[rgba(217,119,87,0.15)] p-6 bg-white hover:border-[rgba(217,119,87,0.3)] transition-colors">
          ...
          <div className="rounded-2xl border border-[rgba(217,119,87,0.15)] p-6 bg-white hover:border-[rgba(217,119,87,0.3)] transition-colors">
            ...
            <a href="#" className="mt-3 inline-flex items-center justify-center w-full h-11 rounded-xl bg-[#d97757] text-white font-semibold hover:bg-[#e89b7d] transition-colors">Agendar demo</a>
          </div>
        </div>
      </section>
