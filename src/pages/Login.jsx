    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-0">
        ...
        <div className="relative min-h-[70vh] md:min-h-screen">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 bottom-2 md:bottom-6 w-[92%] md:w-[440px]">
            <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-xl border border-gray-200 p-6 md:p-7 animate-scale-in">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="submit" className="w-full h-12 rounded-[12px] bg[#092116] bg-[#092116] text-white hover:brightness-110">
                  Entrar
                </Button>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button type="button" variant="outline" className="w-full h-11 rounded-[12px]">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="18" height="18">
                      ...
                      <path fill="#FF3D00" d="M6.306,14.691l6.571,4.817C14.655,16.108,18.961,14,24,14c3.059,0,5.842,1.154,7.961,3.039 l5.657-5.657C33.64,6.053,29.084,4,24,4C16.318,4,9.656,8.337,6.306,14.691z"/>
                      <path fill="#4CAF50" d="M24,44c5.166,0,9.86-1.977,13.409-5.197l-6.199-5.238C29.136,35.091,26.715,36,24,36 c-5.202,0-9.62-3.317-11.281-7.946l-6.53,5.027C9.49,39.556,16.227,44,24,44z"/>
                      <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.236-2.231,4.166-3.999,5.565 c0.001-0.001,0.002-0.001,0.003-0.002l6.199,5.238C36.973,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"/>
                    </svg>
                    Google
                  </Button>
                  <Button type="button" variant="outline" className="w-full h-11 rounded-[12px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
                      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.447-2.136 2.943v5.663H9.351V9h3.414v1.561h.049c.476-.9 1.637-1.852 3.37-1.852 3.604 0 4.268 2.372 4.268 5.455v6.288z" fill="#0A66C2"/>
                      <path d="M5.337 7.433c-1.144 0-2.065-.926-2.065-2.066 0-1.141.921-2.066 2.065-2.066 1.141 0 2.066.925 2.066 2.066 0 1.14-.925 2.066-2.066 2.066zM7.114 20.452H3.561V9h3.553v11.452z" fill="#0A66C2"/>
                    </svg>
                    LinkedIn
                  </Button>
                </div>
                <div className="text-xs text-gray-500 text-center mt-4">
                  ...
                  <a href="/termos-de-uso" className="underline underline-offset-4 text-[#092116]"> Termos de Uso</a>,
                  <a href="/termos-de-servico" className="underline underline-offset-4 text-[#092116]"> Termos de Serviço</a> e
                  <a href="/politica-de-privacidade" className="underline underline-offset-4 text-[#092116]"> Política de Privacidade</a>.
                </div>
              </form>
            </div>
          </div>
