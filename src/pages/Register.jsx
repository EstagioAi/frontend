    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="relative min-h-[70vh] md:min-h-screen">
          ...
          {/* Cartão de registro */}
          <div className="absolute left-1/2 -translate-x-1/2 md:left-auto md:translate-x-0 md:right-10 bottom-2 md:bottom-6 w-[92%] md:w-[440px]">
            <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-xl border border-gray-200 p-6 md:p-7 animate-scale-in">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center gap-3 my-3">
                  ...
                  <span className="text-xs text-gray-500">ou cadastre-se com</span>
                  <div className="h-px bg-gray-200 flex-1" />
                </div>
