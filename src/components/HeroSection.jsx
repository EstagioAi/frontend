...
import { Sparkles, GraduationCap, Building, TrendingUp, Users } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="animate-fade-in-up">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
            A primeira plataforma construída especificamente para resolver as frustrações dos universitários brasileiros.
            <br />
            <span className="text-brand-neon font-semibold">Transparência total</span>,
            <span className="text-brand-purple font-semibold"> feedback garantido</span> e
          ...
          {/* Hero Stats */}
          <div id="hero-stats" className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="glassmorphism-strong rounded-3xl p-8 card-hover relative group">
              ...
              <div className="text-5xl font-bold text-brand-neon mb-3 animate-scale-in">80%</div>
            ...
            <div className="glassmorphism-strong rounded-3xl p-8 card-hover relative group delay-200">
              ...
              <div className="text-5xl font-bold text-brand-purple mb-3 animate-scale-in">65%</div>
              <p className="text-gray-600 text-lg font-medium">
            ...
            <div className="glassmorphism-strong rounded-3xl p-8 card-hover relative group delay-400">
              ...
              <div className="text-5xl font-bold text-green-500 mb-3 animate-scale-in">26</div>
              <p className="text-gray-600 text-lg font-medium">
