...
const Footer = () => {
  return (
    <footer className="py-12 px-4 sm:px-6 lg:px-8 bg-[#212121]">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center space-x-2 mb-4 md:mb-0">
            <div className="w-8 h-8 bg-[#01E297] rounded-lg flex items-center justify-center">
              <span className="text-black font-bold text-lg">E</span>
            </div>
            <span className="text-xl font-bold text-white">EstagioAI</span>
          </div>

          <div className="text-center md:text-left mb-4 md:mb-0">
            <p className="text-white/80">De universitários, para universitários</p>
          </div>

          <div className="flex space-x-4">
            <a href="#" className="w-10 h-10 bg-white/10 text-white/90 rounded-lg flex items-center justify-center hover:bg-white/20 transition-colors" aria-label="Email">
            ...
            <a href="#" className="w-10 h-10 bg-white/10 text-white/90 rounded-lg flex items-center justify-center hover:bg-white/20 transition-colors" aria-label="LinkedIn">
            ...
            <a href="#" className="w-10 h-10 bg-white/10 text-white/90 rounded-lg flex items-center justify-center hover:bg-white/20 transition-colors" aria-label="GitHub">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div className="mt-8 pt-8 border-t border-white/10 text-center">
          <p className="text-white/60 text-sm">© 2024 EstagioAI. Todos os direitos reservados. MVP em desenvolvimento.</p>
        </div>
      </div>
    </footer>
  )
