    ...
    <footer className="py-12 px-4 sm:px-6 lg:px-8 bg-gray-100">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:grid md:grid-cols-3 items-center gap-6">
          <div className="flex justify-start w-full md:w-auto">
            <a href="/" className="flex items-center mb-4 md:mb-0">
              <img src="/logo.svg" alt="EstagioAI" className="footer-logo" />
            </a>
          </div>

          <div className="text-center md:flex md:items-center md:justify-center mb-4 md:mb-0">
            <p className="text-gray-700 text-sm md:text-base font-medium">De universitários, para universitários</p>
          </div>

          <div className="flex justify-end w-full md:w-auto space-x-3">
            <a href="#" className="w-10 h-10 rounded-lg flex items-center justify-center border border-gray-300 bg-white text-gray-600 hover:bg-gray-50 hover:text-black shadow-sm transition-colors" aria-label="Email">
            ...
            <a href="#" className="w-10 h-10 rounded-lg flex items-center justify-center border border-gray-300 bg-white text-gray-600 hover:bg-gray-50 hover:text-black shadow-sm transition-colors" aria-label="LinkedIn">
            ...
            <a href="#" className="w-10 h-10 rounded-lg flex items-center justify-center border border-gray-300 bg-white text-gray-600 hover:bg-gray-50 hover:text-black shadow-sm transition-colors" aria-label="GitHub">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 text-center">
          <p className="text-gray-600 text-sm">© 2024 EstagioAI. Todos os direitos reservados. MVP em desenvolvimento.</p>
        </div>
      </div>
    </footer>
  )
