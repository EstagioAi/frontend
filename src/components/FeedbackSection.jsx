      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
            <h3 className="text-xl font-bold text-brand-purple mb-6">Dashboard de Candidaturas</h3>
            ...
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
              <p className="text-sm text-gray-700">
                ✅ Seu currículo foi visualizado! A entrevista está agendada para amanhã às 14h.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8">
              Dashboard Kanban pessoal mostra o progresso de cada candidatura em tempo real.{' '}
              <span className="text-brand-purple font-semibold">Empresas são obrigadas</span>{' '}
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 bg-brand-purple rounded-full"></div>
                <span className="text-gray-700">Notificações push e email em tempo real</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 bg-brand-purple rounded-full"></div>
                <span className="text-gray-700">Feedback detalhado obrigatório das empresas</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 bg-brand-purple rounded-full"></div>
                <span className="text-gray-700">Histórico completo de todas as interações</span>
              </div>
            </div>
          </div>
        </div>
