...
const Footer = () => {
  return (
    <footer className="py-16 px-4 sm:px-6 lg:px-8 bg-[#0b0b0b] text-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:grid md:grid-cols-3 items-center gap-6">
          ...
          <div className="flex justify-end w-full md:w-auto space-x-3">
            <a
              href="#"
              className="w-10 h-10 rounded-lg flex items-center justify-center border border-white/15 bg-transparent text-white/80 hover:text-white hover:bg-white/5 transition-colors"
              aria-label="Email"
            >
              <svg
                width="18"
