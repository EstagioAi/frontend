...
const FeedbackSection = () => {
  return (
    <section className="relative overflow-hidden py-24 text-white" style={{ background: '#3d3d3a' }}>
      ...
      <div className="mx-auto grid w-full max-w-6xl gap-16 px-4 sm:px-6 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-center lg:px-8">
        <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-white/5 p-8 text-white backdrop-blur-md" style={{ boxShadow: '0 45px 80px -45px rgba(217, 119, 87, 0.25)' }}>
          ...
          <div className="mt-8 space-y-6">
            ...
            <div className="rounded-2xl p-4 text-sm text-white/80" style={{ border: '1px solid rgba(217, 119, 87, 0.4)', background: 'rgba(217, 119, 87, 0.1)' }}>
