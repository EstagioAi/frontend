        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8">
              Todas as vagas seguem o mesmo formato estruturado e padronizado,
              com seções obrigatórias que{" "}
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 bg-[#01E297] rounded-full"></div>
                <span className="text-gray-700">
                  Responsabilidades claras do dia a dia
                </span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 bg-[#01E297] rounded-full"></div>
                <span className="text-gray-700">
                  Tecnologias e habilidades que você vai aprender
                </span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 bg-[#01E297] rounded-full"></div>
          ...
          <div className="muted-card p-6 md:p-8">
            <h3 className="text-xl font-semibold text-[#01E297] mb-6">
              Estrutura Padronizada
            </h3>

            <div className="space-y-4">
              <div className="border-l-4 border-[#01E297] pl-4">
                <h4 className="font-semibold text-[#01E297] mb-1">
                  Sobre a Empresa
                </h4>
                <p className="text-sm text-gray-600">
                  Startup EdTech de 50 pessoas, ambiente descontraído, foco em
                  inovação...
                </p>
              </div>
              ...
              <div className="border-l-4 border-[#092116] pl-4">
                <h4 className="font-semibold text-[#092116] mb-1">
                  Processo Seletivo
                </h4>
                <p className="text-sm text-gray-600">
                  1. Inscrição → 2. Teste técnico → 3. Entrevista → 4. Feedback
                  final
                </p>
              </div>
            </div>
