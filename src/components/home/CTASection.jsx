      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 animate-fade-in-up">
          <h2 className="text-3xl md:text-5xl font-black mb-6 text-black">
            Pronto para mudar sua <span className="text-[#01E297]">experiência</span> de busca?
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 animate-scale-in">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold text-black mb-2">Sou Estudante</h3>
            </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 animate-scale-in">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold text-black mb-2">Sou Empresa</h3>
            </div>
