    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Cartão real de vaga */}
          <div className="job-card bg-white rounded-2xl p-6 shadow-lg border border-gray-200/80 relative animate-scale-in transition-all hover:shadow-xl hover:-translate-y-0.5 ring-1 ring-transparent hover:ring-[#01E297]/20">
            {/* Barra de progresso no canto superior direito */}
            <div className="progress-bar-container">
              <div className="progress-bar" style={{width: '85%', background: 'linear-gradient(90deg,#FACC15,#01E297)'}}></div>
            </div>
            ...
            <div className="skills-container">
              ...
              <div className="skills-list">
                <span className="skill-tag bg-[#01E297]/10 text-[#092116] ring-1 ring-[#01E297]/30">React</span>
                <span className="skill-tag bg-[#01E297]/10 text-[#092116] ring-1 ring-[#01E297]/30">TypeScript</span>
                <span className="skill-tag bg-[#01E297]/10 text-[#092116] ring-1 ring-[#01E297]/30">CSS</span>
                <span className="skill-tag bg-[#01E297]/10 text-[#092116] ring-1 ring-[#01E297]/30">Git</span>
                <span className="skill-tag bg-[#01E297]/10 text-[#092116] ring-1 ring-[#01E297]/30">APIs REST</span>
              </div>
            </div>
